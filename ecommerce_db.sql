...
(1, 1, 'Đặc sản Vân Đình: Vịt ủ xì dầu', 'Vịt ủ xì dầu nguyên con', 'https://res.cloudinary.com/dpq4bt42x/image/upload/v1761789579/VIT-U-XI-DAU-1_o1t66k.png', 'Việt Nam', '2026-12-31', 'active'),
...
(4, 1430000, 'delivered', 'paid', '789 Trần Hưng Đạo, Hoàn Kiếm, Hà Nội', 'COD', 'Để ở bảo vệ nếu không có người');
...
-- BLOGS
INSERT INTO blogs (user_id, title, thumbnail, content) VALUES
(2, 'Mẹo bảo quản nước ngọt', 'blog1.jpg', '<p>Để nước ngọt luôn ngon, nên bảo quản ở nhiệt độ mát...</p>'),
(2, 'Cách pha cà phê ngon', 'blog2.jpg', '<p>Pha cà phê chuẩn cần có nước sôi và tỉ lệ hợp lý...</p>');
...
INSERT INTO shipments (order_id, tracking_number, carrier, status, shipped_date, delivered_date) VALUES
(2, 'VN-2025-001', 'Giao Hàng Nhanh', 'delivered', '2025-10-20 10:00:00', '2025-10-22 14:30:00'),
(3, 'VN-2025-002', 'Giao Hàng Tiết Kiệm', 'in_transit', '2025-10-28 09:00:00', NULL),
(4, 'VN-2025-003', 'ViettelPost', 'delivered', '2025-10-15 08:30:00', '2025-10-17 16:00:00');
